...
- `test_web_ui/` — contenu des 3 pages (matériel/plongée/tables), sélection ppO2 correcte, statut/bouton de calibration, JSON de statut, table MOD réutilisée telle quelle depuis `mod_table.h`.
